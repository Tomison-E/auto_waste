...
import 'package:auto_waste/ui/page/shopping/shopping_two/product_desc2.dart';
...
class _ProductCardState extends State<ProductCard>
  ...
  Widget productCard() {
    var cardHeight = deviceSize.height * 0.5;
    ...
    return Card(
      ...
      child: Ink(
        ...
        child: new Stack(
          children: <Widget>[
            Container(
              height: cardHeight - cardHeight / 3 * 1.1,
